            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        @php
                            if (\App\Models\LocationQR::count() === 0) {
                        ...
                        <form action="{{route('locationupload')}}" method="post">
                            @csrf
                            ...
                            <div class="mb-3">
                                <label for="companyName" class="form-label">Current Location</label>
                            ...
                            <div class="mb-3">
                                <label for="batchNumber" class="form-label">Describe Address</label>
