                    ...
                    <div class="card-body">
                        ...
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="companyName" name="companyName" value="{{$product->company_name}}" required readonly>
                            </div>
                            <div class="mb-3">
                                <label for="productName" class="form-label">Product Name</label>
                                <input type="text" class="form-control" id="productName" name="productName" value="{{$product->product_name}}" required readonly>
                            </div>
                            <div class="mb-3">
                                <label for="batchNumber" class="form-label">Batch Number</label>
                                <input type="text" class="form-control" id="batchNumber" name="batchNumber" value="{{$product->batch_number}}" required readonly>
                            </div>
                            <div class="mb-3">
                                <label for="makingDate" class="form-label">Making Date</label>
                                <input type="date" class="form-control" id="makingDate" name="makingDate" value="{{$product->making_date}}" required readonly>
                            </div>
                            <div class="mb-3">
                                <label for="expiryDate" class="form-label">Expired Date</label>
                                <input type="date" class="form-control" id="expiryDate" name="expiryDate" value="{{$product->expired_date}}" required readonly>
                            </div>
                            <a href="{{route('productqr',['id'=>$id->id])}}" class="btn btn-primary">Re-Generate</a>
                        </form>
                    </div>
                </div>
            </div>
