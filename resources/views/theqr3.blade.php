                    ...
                    <div class="card-body">
                        ...
                        <form>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="companyName" value="{{$product->userfrom}}" name="companyName" required readonly>
                            </div>
                            <div class="mb-3">
                                <label for="productName" class="form-label">To</label>
                                <input type="email" class="form-control" id="productName" value="{{$product->userto}}" name="productName" required readonly>
                            </div>
                            <div class="mb-3">
                                <label for="batchNumber" class="form-label">Message</label>
                                <textarea class="form-control" name="batchNumber"required readonly>{{$product->smsmessage}}</textarea>
                            </div>
                            <a href="{{route('emailqr',['id'=>$id->id])}}" class="btn btn-primary">Re-Generate</a>
                        </form>
                    </div>
                </div>
            </div>
